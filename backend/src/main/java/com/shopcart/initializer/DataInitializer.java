package com.shopcart.initializer;
...
import com.shopcart.coupon.repository.CouponRepository;
...
public class DataInitializer implements CommandLineRunner {
    ...
    private void createDefaultProducts() {
        ...
        List<Inventory> inventories = List.of(
                Inventory.builder().productId("P001").quantity(50).build(),
                Inventory.builder().productId("P002").quantity(50).build(),
                Inventory.builder().productId("P003").quantity(50).build(),
                Inventory.builder().productId("P004").quantity(50).build(),
                Inventory.builder().productId("P005").quantity(50).build(),
                Inventory.builder().productId("P006").quantity(50).build(),
                Inventory.builder().productId("P007").quantity(50).build(),
                Inventory.builder().productId("P008").quantity(50).build(),
                Inventory.builder().productId("P009").quantity(50).build(),
                Inventory.builder().productId("P010").quantity(50).build()
        );
