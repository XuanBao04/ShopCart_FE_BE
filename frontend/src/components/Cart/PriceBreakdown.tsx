    ...
    return (
      <div className="space-y-2 text-sm">
        ...
        <div className="flex justify-between">
          ...
          <span>{formatPrice(shippingFee)} VND</span>
        </div>

        <div className="flex justify-between border-t pt-2 font-bold">
          <span>Tổng cộng:</span>
          <span className="text-lg">{formatPrice(totalPrice)} VND</span>
        </div>
      </div>
    );
  }
    ...
    <div className="border rounded-lg p-4 bg-gray-50">
      ...
      <div className="space-y-3">
        <div className="flex justify-between text-base">
          ...
          <span className="font-semibold">{formatPrice(subtotal)} VND</span>
        </div>
        ...
        <div className="flex justify-between text-base">
          ...
          <span className="font-semibold">{formatPrice(shippingFee)} VND</span>
        </div>
